...
def Page_selected():
    ...
    if choice_App==5000:
        ...
        df=df[5000<df['ApplicantIncome'] and df['ApplicantIncome']<=10000]
    elif choice_App==15000:
        df=df[10000<df['ApplicantIncome'] and df['ApplicantIncome']<=15000]
    elif choice_App==20000:
        df=df[15000<df['ApplicantIncome'] and df['ApplicantIncome']<=20000]
    else:
    ...
    if choice_Coapp==0:
        ...
        df=df[0<df['CoapplicantIncome'] and df['CoapplicantIncome']<=3000]
    elif choice_Coapp==6000:
        df=df[3000<df['CoapplicantIncome'] and df['CoapplicantIncome']<=6000]
    elif choice_Coapp==10000:
        df=df[6000<df['CoapplicantIncome'] and df['CoapplicantIncome']<=10000]
    else:
